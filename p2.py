...
from sklearn.metrics import mean_squared_error, jaccard_score, precision_recall_fscore_support, confusion_matrix, ConfusionMatrixDisplay
...
for i in min_samples:
    clf = tree.DecisionTreeClassifier(min_samples_leaf=i).fit(X_train, y_train)
...
# (iii)
bestMinNumberSamples = min_samples[accuracy_array.index(max(accuracy_array))]
